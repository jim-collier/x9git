...
func (a *app) printSyntax() {
	...
	a.out.clean("  identity ...........: Who commands here act as: account, ssh key, commit author, gh login.")
	...
	a.out.clean("  pr [create|n|ok n] .: Create, list, review, or accept a pull request (needs gh).")
